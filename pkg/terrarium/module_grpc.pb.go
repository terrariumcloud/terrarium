...
type PublisherClient interface {
	Configure(ctx context.Context, in *ModuleConfigurationRequest, opts ...grpc.CallOption) (*TransactionStatusResponse, error)
...
func (c *publisherClient) Configure(ctx context.Context, in *ModuleConfigurationRequest, opts ...grpc.CallOption) (*TransactionStatusResponse, error) {
	out := new(TransactionStatusResponse)
	err := c.cc.Invoke(ctx, "/terrarium.module.Publisher/Configure", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type Publisher_UploadSourceZipClient interface {
	Send(*UploadSourceZipChunkRequest) error
...
func (x *publisherUploadSourceZipClient) Send(m *UploadSourceZipChunkRequest) error {
...
type PublisherServer interface {
	Configure(context.Context, *ModuleConfigurationRequest) (*TransactionStatusResponse, error)
...
func (UnimplementedPublisherServer) Configure(context.Context, *ModuleConfigurationRequest) (*TransactionStatusResponse, error) {
...
func _Publisher_Configure_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ModuleConfigurationRequest)
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/terrarium.module.Publisher/Configure",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PublisherServer).Configure(ctx, req.(*ModuleConfigurationRequest))
	}
...
type Publisher_UploadSourceZipServer interface {
	...
	Recv() (*UploadSourceZipChunkRequest, error)
	grpc.ServerStream
}
...
func (x *publisherUploadSourceZipServer) Recv() (*UploadSourceZipChunkRequest, error) {
	m := new(UploadSourceZipChunkRequest)
...
var Publisher_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/terrarium/module.proto",
}
...
type Consumer_DownloadSourceZipClient interface {
	Recv() (*SourceZipChunkResponse, error)
	grpc.ClientStream
}
...
func (x *consumerDownloadSourceZipClient) Recv() (*SourceZipChunkResponse, error) {
	m := new(SourceZipChunkResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type Consumer_DownloadSourceZipServer interface {
	Send(*SourceZipChunkResponse) error
	grpc.ServerStream
}
...
func (x *consumerDownloadSourceZipServer) Send(m *SourceZipChunkResponse) error {
	return x.ServerStream.SendMsg(m)
}
